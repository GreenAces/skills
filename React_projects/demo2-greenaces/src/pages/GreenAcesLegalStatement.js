...
function LegalStatement()  {
  ...
  return (<React.Fragment>
    ...
    you agree to the terms and conditions outlined in this statement. <br></br>
    ...
    on the GreenAces website. <br></br>
    ...
    changes have been made constitutes your acceptance of the changes. <br></br>
    ...
    outlined in this statement. <br></br>
    </p>
    </div>
