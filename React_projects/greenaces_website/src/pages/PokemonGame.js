...
9)
10)
11) Use button#soundOnText for pokemonGame.css to make your style more specific and force style changes
...
function PokemonGame() {
  ...
  const [playerPokeImage, setPlayerPokeImage] = useState();
  const [cpuPokeImage, setCpuPokeImage] = useState();
  ...
  const defenseC_Sta = useState("");
   ...
   //Pokemon section - images:   
    ...
    //Pokemon toggle sound ON/OFF: (part 1/2)
    ...
    //Toggle Pokemon Sound On/Off: (part 2/2)
    //This function uses SoundButton.js as a component 
...
<React.Fragment> 
    ...
    <Helmet>
      <title>GreenAces -- Pokemon Game |
      Pick your favorite pokemon and let them duel against your opponent. If all 3 pokemon are dead then you lose!</title>
    </Helmet>
    ...
    <div className="col" id ="column12">
      ...
      <div className="col" id ="column13">
        ...
        <div className="col" id ="column14">
         ...
         <SoundButton isSoundOn={isSoundOn} toggleSound={toggleSound} id="SoundONText " />
          {isSoundOn && (

              <Sound
              url={gameboy_battleThemeMp3}
